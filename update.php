	...
	include 'connect.inc.php';
      include 'core.inc.php';
		if(isset($_POST['firstname']) && isset($_POST['lastname']) && isset($_POST['email_id']) && isset($_POST['contact']) && isset($_POST['department']) && isset($_POST['year']) && isset($_POST['about']) && isset($_POST['intermediate']) && isset($_POST['college']) && isset($_POST['address']) && isset($_POST['gender']) && isset($_POST['date_of_birth']) && isset($_POST['year_of_passing']))
		{
			...
			$query="UPDATE Student SET Firstname='$first_name', Lastname='$last_name', Email_id='$email_id', Contact='$contact', Department='$department', Year=$year, About='$about', Intermediate='$intermediate', College='$college', Address='$address', Gender='$gender', Date_of_birth='$date_of_birth', Year_of_passing=$year_of_passing WHERE id=".$_SESSION['user_id_student'];
