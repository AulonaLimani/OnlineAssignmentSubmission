...
<head>
    <title>View Submissions Faculty-BRIGHT MIND!</title>
...
<br><br><br><br>
<div class="container">
    <h1>The<span style="color: #284B63; font-weight: bolder"> submissions for assignments</span> posted by
        <span style="color: #284B63;font-weight: bolder"><?php echo $first_name . ' ' . $last_name; ?></span></h1>
    <div id="body">
        <table width="80%" border="1" class="responstable">
            <tr >
                    <th colspan="12" style="background-color: #3C6E71">YOUR UPLOADS... <label><a href="post_assignment.php">upload new files...</a></label>
                </th>
            </tr>
            <tr>
