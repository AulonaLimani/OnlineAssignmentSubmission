...
{    
 ...
 {
  $sql="INSERT INTO Assignment(assignmentid,file,type,size,username,firstname,lastname,department,year,subject,date) VALUES($assignmentid,'$final_file','$file_type', $new_size,'$username','$first_name','$last_name','$department', $year,'$subject','$date')";
